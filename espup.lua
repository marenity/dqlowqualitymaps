...
function boxBase:Update()
	...
	local locs = {
		TopLeft 	= cf * ESP.BoxShift * CFrame.new(size.X   / 2,  size.Y / 1.4, 0),
		TopRight 	= cf * ESP.BoxShift * CFrame.new(-size.X  / 2,  size.Y / 1.4, 0),
		BottomLeft 	= cf * ESP.BoxShift * CFrame.new(size.X   / 2, -size.Y / 3, 0),
		BottomRight = cf * ESP.BoxShift * CFrame.new(-size.X  / 2, -size.Y / 3, 0),
